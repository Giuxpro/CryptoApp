            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="relative">
                ...
                <span
                  ...
                  className="absolute right-3 top-2/3 transform -translate-y-1/2 cursor-pointer text-xl"
                >
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                ...
                <a href="/signup" className="font-medium text-blue-600 hover:underline dark:text-primary-500">
                  Sign up
                </a>
              </p>
            </form>
